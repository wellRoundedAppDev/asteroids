...
class AsteroidsAdapter(private val onClickListener: OnClickListener): ListAdapter<Asteroid, AsteroidsAdapter.AsteroidViewHolder>(DiffCallback) {
    class AsteroidViewHolder(private var binding: AstroidItemBinding) :RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AsteroidViewHolder {
        return AsteroidViewHolder(AstroidItemBinding.inflate(LayoutInflater.from(parent.context)))
    }
